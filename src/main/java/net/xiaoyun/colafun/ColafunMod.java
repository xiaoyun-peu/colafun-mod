package net.xiaoyun.colafun;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.xiaoyun.colafun.init.ColafunModTabs;
import net.xiaoyun.colafun.init.ColafunModMobEffects;
import net.xiaoyun.colafun.init.ColafunModItems;
import net.xiaoyun.colafun.init.ColafunModBlocks;
...
@Mod("colafun")
public class ColafunMod {
	public static final Logger LOGGER = LogManager.getLogger(ColafunMod.class);
	public static final String MODID = "colafun";

	public ColafunMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ColafunModBlocks.REGISTRY.register(modEventBus);
		ColafunModItems.REGISTRY.register(modEventBus);
		ColafunModTabs.REGISTRY.register(modEventBus);
		ColafunModMobEffects.REGISTRY.register(modEventBus);
